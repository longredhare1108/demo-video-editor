import { LOGIN, UPDATE_COMPANY_ACCOUNT, UPDATE_LECTURER_ACCOUNT, DELETE_LECTURER_ACCOUNT,UPDATE_STUDENT_ACCOUNT } from '../URL/user-url';
import axios from 'axios';
import { headers } from '../util/headers';
export default {
    login: data => axios.post(LOGIN, JSON.stringify(data), {headers}).then(res => res.data),
